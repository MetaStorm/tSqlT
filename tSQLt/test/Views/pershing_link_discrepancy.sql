CREATE VIEW [test].[pershing_link_discrepancy] AS
WITH  D AS
(SELECT n.NURACI,
                       n.NUREFE
...
SELECT AccountNumber+'/'+MasterMnemonic+'/'+DDALink [Account Number], Date, OlympicAccount, MasterMnemonic, DDALink, BankLinkDDANumber, AccountStatusIndicator, PositionCount
